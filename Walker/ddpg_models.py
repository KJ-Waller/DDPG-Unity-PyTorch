...
class ActorNet(nn.Module):
    ...
    def __init__(self, lr, state_dim, l1_size, l2_size, l3_size, l4_size, action_dim, name=None):
        ...
        self.bn4 = nn.LayerNorm(l4_size)
        self.mu = nn.Linear(l4_size, action_dim)
    ...
    def init_weights(self):
        ...
        f6 = .003
        nn.init.uniform_(self.mu.weight.data, -f6, f6)
        nn.init.uniform_(self.mu.bias.data, -f6, f6)
...
class CriticNet(nn.Module):
    ...
    def init_weights(self):
        ...
        nn.init.uniform_(self.fc4.bias.data, -f4, f4)
        f6 = .003
        nn.init.uniform_(self.q.weight.data, -f6, f6)
        nn.init.uniform_(self.q.bias.data, -f6, f6)
    ...
    def forward(self, state, action):
        ...
        state_value = self.bn4(self.fc4(state_value))
